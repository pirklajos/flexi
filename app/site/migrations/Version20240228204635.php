...
final class Version20240228204635 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO flexi.tooth (`position`,position_numeric) VALUES (\'Bal felső 1\',11), (\'Bal felső 2\',12), (\'Bal felső 3\',13), (\'Bal felső 4\',14), (\'Bal felső 5\',15), (\'Bal felső 6\',16), (\'Bal felső 7\',17), (\'Bal felső 8\',18);');
        ...
        $this->addSql('INSERT INTO flexi.tooth (`position`,position_numeric) VALUES (\'Bal alsó 1\',41), (\'Bal alsó 2\',42), (\'Bal alsó 3\',43), (\'Bal alsó 4\',44), (\'Bal alsó 5\',45), (\'Bal alsó 6\',46), (\'Bal alsó 7\',47), (\'Bal alsó 8\',48);');
